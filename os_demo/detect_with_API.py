...
from os_demo.yolov7.models.experimental import attempt_load
from os_demo.yolov7.utils.datasets import MyLoadImages
from os_demo.yolov7.utils.general import check_img_size, non_max_suppression, apply_classifier, \
    scale_coords, set_logging
from os_demo.yolov7.utils.plots import plot_one_box
from os_demo.yolov7.utils.torch_utils import select_device, load_classifier
...
class detectapi:
    ...
    def detect1(self, source):  # 使用时，调用这个函数
        if type(source) != list:
